...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        self.epsilon = args.get('epsilon', 0.05)  # exploration rate
        self.gamma = args.get('gamma', 0.8)  # discount factor
        self.alpha = args.get('alpha', 0.2)  # learning rate
        self.numTraining = args.get('numTraining', 0)  # number of training episodes

        # Initialize Q-values storage (as a dictionary)
        self.qValues = {}
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        """
        "*** YOUR CODE HERE ***"
        features = self.featExtractor.getFeatures(state, action) # getting features
